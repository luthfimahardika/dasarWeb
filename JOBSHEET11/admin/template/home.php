<div class="container-fluid">
    ...
    $query_anggota = "SELECT count(id) as jml_anggota FROM anggota";
    $result_anggota = mysqli_query($koneksi, $query_anggota);
    $row_anggota = mysqli_fetch_assoc($result_anggota);

    $query_jabatan = "SELECT count(id) as jml_jabatan FROM jabatan";
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Total anggota sejumlah <?php echo $row_anggota['jml_anggota']; ?> orang.</p>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Total jabatan sejumlah <?php echo $row_jabatan['jml_jabatan']; ?>.</p>
