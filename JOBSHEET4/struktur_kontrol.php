...
if (count($nilaiSiswa) > 0) {
    echo "Total nilai dari siswa setelah mengabaikan dua nilai tertinggi dan dua ternedah adalah: $nilaiTotal<br>";
    echo "Nilai rata-rata dari nila siswa tersebut adalah: " . $nilaiTotal / count($nilaiSiswa);
} else {
